...
model.compile(optimizers=adam_optimizer, loss = loss_function, metrics=[metric])
...
test_img = cv2.imread("CV-practice\Image-processing-2\2.png", cv2.IMREAD_GRAYSCALE)
print(test_img)
